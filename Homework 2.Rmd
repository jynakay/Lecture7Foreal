...
1. Question 1: What kind of R object is the `Davis` dataset?

2. Question 2: How many observations are in the `Davis` dataset?

3. Question 3: For reported weight, how many observations have a missing value?

4. Question 4: How many observations have no missing values? _(HINT: find complete cases)_

Create a subset containing only females.

5. Question 5: How many females are in this subset?
...
Create the BMI variable and then a variable to depict BMI category. Note that the `height` variable is in centimeters, and `weight` is in kg. _[HINT: Type `?car::Davis` in the Console to bring up the HELP pages on the `Davis` dataset in the `car` package.]_

Now answer these questions:

6. Question 6: What is the average BMI for these individuals?

7. Question 7: How do these individuals fall into the BMI categories (what are the frequencies and relative %'s)?
